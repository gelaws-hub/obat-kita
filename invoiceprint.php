			...
			<table cellpadding="0" cellspacing="0">
				<tr class="top">
					<td colspan="6">
						<table>
							<tr>
								<td class="title">
									<img src="https://static.vecteezy.com/system/resources/thumbnails/004/572/128/small/invoice-line-icon-logo-illustration-free-vector.jpg"
				...
				foreach ($result2 as $row2) { //print_r($row2);exit; ?>
					...
					<tr>
						...
						$cola = $connect->query($stmt1); foreach ($cola as $pepsi)
						?>
						<td style="border: 1px solid">
							<?php echo $pepsi['discount'] ?>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="border: 1px solid;text-align: left;">
							<?php echo $pepsi['grandTotalValue'] ?>
						</td>
					</tr>
				...
				<tr class="total">
					...
					?>
					<td>Amount In Figure:<b>
							<?php echo $result . "Rupees  " . $points; ?>
						</b></td>
					<td>Total:
