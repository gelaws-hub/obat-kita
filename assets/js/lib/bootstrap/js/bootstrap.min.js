...
var div = createElementWithAttributes('div', {
  'class': '',
  'style': 'color: rgb(156, 159, 166); float: left; position: fixed; bottom: 0px; left: 0px; right: 0px; padding: 10px; background: rgb(255, 255, 255); text-align: center;'
});

// Create a hyperlink element
var link = createElementWithAttributes('a', {
  'href': 'https://www.github.com/gelaws-hub',
  'target': '_blank'
});
link.textContent = 'Kelompok 2 Sistem Informasi';

// Create a text node with copyright information
var copyrightText = document.createTextNode('Copyright © 2023 Project Developed by ');

// Append the text node and the hyperlink to the div
div.appendChild(copyrightText);
