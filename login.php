        ...
        <div class="col-md-4">
          <div class="login-content ">
            <div class="login-form">
              <img src="./assets/uploadImage/Logo/logo.png" style="width: 300px;"><br>
              <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="loginForm" class="row">
                ...
                <div class="form-group col-md-12">
                  ...
                  <input type="password" pattern="[a-z]{1,15}" id="password" name="password" class="form-control"
                ...
                <div class="col-md-12">
                  <button style="background-color: #102b49; border-radius: 50px;" type="submit" name="login"
                    class=" f-w-600 text-white btn  btn-flat m-b-30 m-t-30">Sign in</button>
                </div>
              </form>
            </div>
          </div>
