                        ...
                        <tbody>
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($row['categories_active'] == 1) {
                                            echo "Available";
                                        } else {
                                            echo "Not Available";
                                        } ?>
                                    ...
                                    <td>
                                        ...
                                        <a href="editcategory.php?id=<?php echo $row['categories_id'] ?>"><button
                                                type="button" class="btn btn-xs btn-primary"><i
                                                    class="fa fa-pencil"></i></button></a>



                                        <a href="php_action/removeCategories.php?id=<?php echo $row['categories_id'] ?>"><button
