    ...
    <div class="row">
      <div class="col-lg-11" style="    margin-left: 5%;">
        <div class="card">
          ...
          <div class="form-group">
            <div class="row">
              <label for="vat" class="col-sm-2 control-label gst">TAX 10%</label>
              <div class="col-sm-4">
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <select class="form-control" name="paymentPlace" id="paymentPlace">
                  <option value="">~~SELECT~~</option>
                  <option value="1">in Semarang</option>
                  <option value="2">Out Of Semarang</option>
                </select>
              </div>
            </div>
          </div>
          <div class="form-group submitButtonFooter">
            <div class="col-sm-offset-2 col-sm-10">
              <button type="submit" id="createOrderBtn" data-loading-text="Loading..."
                class="btn btn-success btn-flat m-b-30 m-t-30"><i class="glyphicon glyphicon-ok-sign"></i>
                Submit</button>
